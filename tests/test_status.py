...
from discovery.cli.status_helpers import format_status_text, get_library_status
...
class TestGetLibraryStatus:
    ...
    def test_with_items(self, db: Database) -> None:
        ...
        db.add_wishlist_item(WishlistItem(id="w1", category=Category.MUSIC, title="Wish 1"))
